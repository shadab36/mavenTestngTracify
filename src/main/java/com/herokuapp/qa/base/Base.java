...
import com.herokuapp.qa.util.WebEventListener;
...
public class Base {
	...
	public Base() {
		try {
			...
			FileInputStream ip = new FileInputStream(
					System.getProperty("user.dir") + "/src/main/java/com/" + "/qa/Config/Conf.properties");
			prop.load(ip);
			
			logger=Logger.getLogger("Test tracify");
	...
	public static void initialization() throws MalformedURLException {
		...
		//now create Object for EventListnerHandler to register in with EventFringWebdriver
